  ...
  return (
    ...
    >
      ...
      <div className="flex items-start justify-between">
        ...
        <Plus
          size={17}
          className="text-slate-300 transition group-hover:text-[#0B6B50] dark:text-white/20 dark:group-hover:text-emerald-400"
        />

      </div>


      <h3 className="mt-5 text-sm font-bold text-slate-700 dark:text-white/80">
        {report.title}
      </h3>


      <p className="mt-1 text-[10px] leading-4 text-slate-400 dark:text-white/30">
        {report.description}
      </p>


      <p className="mt-4 text-[10px] font-semibold text-[#0B6B50] dark:text-emerald-400">
        Generate report →
      </p>
...
`;
  ...
  const downloadReport = (report) => {
    ...
    setReportMessage(
      `${report.id} downloaded successfully.`
    );
        ...
        <main className="mx-auto max-w-[1600px] p-5 lg:p-8">
          ...
          <div className="mb-7 flex flex-col justify-between gap-4 lg:flex-row lg:items-end">
            ...
            <div>
              ...
              <p className="mt-1 max-w-2xl text-sm text-slate-500 dark:text-white/45">
                Generate, review and manage environmental monitoring,
                emission and compliance reports.
              </p>
              ...
              {reportTypes.map((report) => (
                ...
                <ReportTypeCard
                  ...
                  onGenerate={(type) => {
                    ...
                    setReportMessage(
                      `${type.title} generated successfully.`
                    );
          ...
          ">
            ...
            <div className="flex-1">
              ...
              <p className="mt-1 text-[10px] text-emerald-700/70 dark:text-emerald-300/50">
                Your automated compliance and monitoring reports will
                be generated according to their configured schedules.
              </p>
                        ...
                        <td className="px-5 py-4">
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <p className="max-w-[280px] truncate text-xs font-semibold text-slate-700 dark:text-white/75">
                                {report.name}
                              </p>
                ...
                {[
                  ...
                  ([name, plant, date]) => (
                    ...
                    >
                      ...
                      <span className="font-mono text-[10px] font-semibold text-[#0B6B50] dark:text-emerald-400">
                        {date}
                      </span>
          ...
          ">
            ...
            <div className="flex-1">
              ...
              <p className="mt-1 text-[10px] text-emerald-700/70 dark:text-emerald-300/50">
                EcoTrust automatically collects monitoring and compliance
                data to generate accurate environmental reports.
              </p>
