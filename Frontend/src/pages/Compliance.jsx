    ...
    <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-[0_4px_20px_rgba(15,23,42,0.03)] transition-colors dark:border-white/10 dark:bg-white/[0.03] dark:shadow-none">
      ...
      <div className="flex items-start justify-between">
        ...
        <div>
          ...
          <h3 className="mt-2 text-2xl font-bold tracking-tight dark:text-white">
            {stat.value}
          </h3>
  ...
  return (
    <div className="relative mx-auto h-[190px] w-[190px]">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center">
        ...
        <span className="mt-1 text-[10px] text-slate-400 dark:text-white/30">
          Plant score
        </span>
...
function ParameterRow({ parameter }) {
  ...
  return (
    <div className="rounded-xl border border-slate-100 p-4 dark:border-white/[0.07]">
...
function ViolationRow({ violation }) {
  ...
  return (
    <div className="flex gap-3 border-b border-slate-100 py-4 last:border-0 dark:border-white/[0.07]">
      ...
      <div className="min-w-0 flex-1">
        ...
        <div className="mt-3 flex items-center justify-between">
          ...
          <span className="font-mono text-[10px] text-slate-500 dark:text-white/45">

            {violation.value}

            <span className="mx-1 text-slate-300 dark:text-white/20">
              vs
            </span>
        ...
        <main className="mx-auto max-w-[1600px] p-5 lg:p-8">
          ...
          <div className="mb-7 flex flex-col justify-between gap-4 lg:flex-row lg:items-end">
            ...
            <div>
              ...
              <p className="mt-1 max-w-2xl text-sm text-slate-500 dark:text-white/45">
                Monitor regulatory compliance, emission limits,
                violations and reporting status across all facilities.
              </p>
            ...
            <div className="flex gap-2">
              ...
              <div className="relative">
                ...
                <select
                  ...
                  className="appearance-none rounded-lg border border-slate-200 bg-white py-2 pl-9 pr-8 text-xs font-medium text-slate-600 outline-none focus:border-[#0B6B50] dark:border-white/10 dark:bg-[#0D2921] dark:text-white/70"
                >
                  ...
                  {plants.map((plant) => (
                    ...
                    <option
                      key={plant.name}
                      value={plant.name}
                      className="bg-white text-slate-700 dark:bg-[#0D2921] dark:text-white"
                    >
                      {plant.name}
                    </option>
          ...
          <section className="mt-5 grid gap-5 xl:grid-cols-[.7fr_1.3fr]">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-[0_4px_20px_rgba(15,23,42,0.03)] dark:border-white/10 dark:bg-white/[0.03] dark:shadow-none">
              ...
              <div className="grid grid-cols-3 border-t border-slate-100 pt-4 text-center dark:border-white/10">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-[0_4px_20px_rgba(15,23,42,0.03)] dark:border-white/10 dark:bg-white/[0.03] dark:shadow-none">
              ...
              <div className="flex items-start justify-between">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="flex items-center gap-1 rounded-full bg-emerald-50 px-2 py-1 text-[8px] font-semibold text-emerald-600 dark:bg-emerald-500/10 dark:text-emerald-400">
                ...
                <button className="flex items-center gap-2 rounded-lg border border-slate-200 px-3 py-2 text-[10px] text-slate-500 dark:border-white/10 dark:text-white/50">
                  7 Days
                  <ChevronDown size={11} />
                </button>
              ...
              <div className="mt-4 flex items-end gap-3">
                ...
                <span className="mb-1 rounded-full bg-emerald-50 px-2 py-1 text-[9px] font-semibold text-emerald-600 dark:bg-emerald-500/10 dark:text-emerald-400">
                  +2.4%
                </span>
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-[0_4px_20px_rgba(15,23,42,0.03)] dark:border-white/10 dark:bg-white/[0.03] dark:shadow-none">
              ...
              <div className="flex items-center justify-between">
                ...
                <div>
                  ...
                  <h3 className="text-sm font-bold dark:text-white">
                    {selectedPlant.name} Parameter Compliance
                  </h3>
                ...
                <button className="text-[10px] font-semibold text-[#0B6B50] dark:text-emerald-400">
                  View all →
                </button>
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-[0_4px_20px_rgba(15,23,42,0.03)] dark:border-white/10 dark:bg-white/[0.03] dark:shadow-none">
              ...
              <div className="flex items-center justify-between">
                ...
                <div>
                  ...
                  <h3 className="text-sm font-bold dark:text-white">
                    {selectedPlant.name} Recent Violations
                  </h3>
              ...
              <div className="mt-3">
                ...
                {selectedViolations.length > 0 ? (
                  ...
                  <div className="py-10 text-center">
                    ...
                    <p className="mt-3 text-xs font-semibold text-slate-700 dark:text-white/75">
          ...
          <section className="mt-5 rounded-2xl border border-emerald-100 bg-emerald-50/60 p-5 dark:border-emerald-500/20 dark:bg-emerald-500/10">
            ...
            <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="mt-0.5 text-[10px] text-emerald-700/70 dark:text-emerald-300/50">
                    {selectedPlant.location} ·{' '}
                    {selectedPlant.score}% compliance ·{' '}
                    {selectedPlant.violations} violations
                  </p>
              ...
              <div className="grid grid-cols-2 gap-2 text-center">
                ...
                <div className="rounded-xl bg-white px-4 py-2.5 dark:bg-white/10">
            ...
            <div className="mt-5 overflow-x-auto">
              ...
              <table className="w-full min-w-[700px]">
                ...
                <thead>
                  ...
                  <tr className="border-b border-slate-100 text-left text-[9px] text-slate-400 dark:border-white/10 dark:text-white/30">
                    ...
                    >
                      ...
                      <td className="py-4">
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-xs font-semibold dark:text-white/75">
                              {plant.name}
                            </p>

                            <p className="mt-0.5 flex items-center gap-1 text-[9px] text-slate-400 dark:text-white/30">
                              <MapPin size={9} />
                              {plant.location}
                            </p>
                      ...
                      <td className="py-4">
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <span className="font-mono text-xs font-semibold dark:text-white/75">
                            {plant.score}%
                          </span>
                      ...
                      <td className="py-4 text-right">
                        ...
                        <button className="rounded-lg border border-slate-200 px-3 py-1.5 text-[9px] font-semibold text-slate-600 transition hover:bg-slate-50 dark:border-white/10 dark:text-white/50 dark:hover:bg-white/5">
                          Review
                        </button>
          ...
          <section className="mt-5 grid gap-5 lg:grid-cols-2">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-5 dark:border-white/10 dark:bg-white/[0.03]">
              ...
              <button className="mt-5 w-full rounded-lg border border-slate-200 py-2.5 text-[10px] font-semibold text-slate-600 transition hover:bg-slate-50 dark:border-white/10 dark:text-white/50 dark:hover:bg-white/5">
                Manage Reports
              </button>
          ...
          <section className="mt-5 flex flex-col gap-3 rounded-2xl border border-emerald-100 bg-emerald-50/50 p-5 dark:border-emerald-500/20 dark:bg-emerald-500/10 sm:flex-row sm:items-center">
            ...
            <div className="flex-1">
              ...
              <p className="mt-1 text-[10px] text-emerald-700/70 dark:text-emerald-300/50">
                EcoTrust is continuously evaluating environmental
                readings against configured compliance thresholds.
              </p>

            </div>

            <span className="flex items-center gap-1.5 rounded-full bg-white px-3 py-1.5 text-[9px] font-semibold text-emerald-600 dark:bg-white/10 dark:text-emerald-400">
